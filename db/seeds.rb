...
# p "1 ticket - done"
 ...
 # activity_1_lyon = Activity.new(title: "Vieux lyon", url:"http://www.blog-in-lyon.fr", step: step_1_rachel)
 # #activity_1_lyon.remote_photo_url = "http://res.cloudinary.com/alumni/image/upload/v1512496157/vieux_lyon_sarcgv.jpg"
 # activity_1_lyon.save!
 # activity_2_lyon = Activity.new(title: "Basilique Notre Dame", url:"https://lyon.citycrunch.fr", step: step_1_rachel )
